...
augroup AutoSaveAll
  ...
  autocmd TextChanged,TextChangedI,InsertLeave *
        \ if &modifiable && bufname('%') != '' | silent! write | endif
augroup END
...
-- ------------------------------------------------------------------
--  COMPLETION SETUP (before LSP so capabilities are ready)
-- ------------------------------------------------------------------
...
-- ------------------------------------------------------------------
--  MASON (INSTALL ONLY - no mason-lspconfig needed for native API)
-- ------------------------------------------------------------------
require('mason').setup()
